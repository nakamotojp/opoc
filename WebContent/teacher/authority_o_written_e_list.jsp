	...
	<div id="container">
		...
		<div id="header">
			...
			<ul id="menu">
				...
				<li><a href="AuthorityReportList"><img
						src="images/menu_02_a.gif" alt="My報告書一覧ページへ" width="120"
						height="50" id="Image2"
		...
		<div id="contents">
			...
			<div id="wrap">
				...
				<div id="main">
					<form name="formMain" method="post" action="WrittenExaminationList"
		...
		%> <%
			...
			%>
									<td><%=u_nameOp%></td>
									<td>
										<% String status = item.getRwe_status();
			if(status.equals("new")){
				...
				out.print("<span class='fontc-1'>再提出</span>");
									...
									<td><input type="button" value="詳細"
										...
										onclick="JUMP(<%=item.getRwe_id()%>)"></input></td>
								</tr>
								<%
			}
		%>
					...
					count = i + 10;
						...
						if(list2.size()>10){
							...
							<table id="table-list">
								...
								<%} i ++;%>
								<tr>
									<td class="right"><%=item.getRwe_introduction() %></td>
									<td class="right"><%=item.getRwe_participate() %></td>
									<%String comp_name = item.getComp_name();
			if(comp_name.length() > 20){
				comp_name = comp_name.substring(0,20) + "...";
			}
