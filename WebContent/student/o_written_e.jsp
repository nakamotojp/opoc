									...
									<tbody>
										...
										<tr>
											...
											<td><INPUT type="text" id="rwe_stage" name="rwe_stage"
												size="5" maxlength="5"
												onkeypress="return handleEnter(this, event)">試験
												<br />
												<span style="color:#999999">例　:　一次試験、一次前試験などと記入</span></td>
										</tr>
										...
										<tr>
											...
											<td><input type="text" id="rwe_exam" name="rwe_exam"
												size="5" maxlength="5"  onkeyDown="return numOnly()"
										...
										<tr>
											...
											<td><INPUT type="text" value="" id="rwe_aptitudetime"
												name="rwe_aptitudetime" size="5" maxlength="5"
												onkeyDown="return numOnly()" onkeypress="return handleEnter(this, event)"
												>分　　<span style="color:#999999">※半角数字のみ、無ければ0と記入</span>
												</td>
										...
										<tr>
											...
											<td><INPUT type="text" value="" id="rwe_writtentime"
												name="rwe_writtentime" size="5" maxlength="5" onkeyDown="return numOnly()"
										...
										<tr>
											...
											<td><INPUT type="text" value="" id="rwe_papertime"
								...
								<table id="table-02">
									...
									<tr>
										...
										<td><input type="radio" value="yes" name="rwe_lang_check"
											...
											name="rwe_lang_check" checked
											onclick="open_close_row('rwe_lang',2);"
											onkeypress="return handleEnter(this, event)" /> <label
											for="rb4">無し</label></td>
									</tr>
									<tr id="rwe_lang1">
										...
										<td><span id="slen2"></span> <span id="mes2-1"
											...
											style="font-size: 12px"></span> <br /> <TEXTAREA
												id="rwe_lang" name="rwe_lang" disabled="true" rows="5"
												cols="50" onfocus="test(2, rwe_lang)"
												onKeyup="test(2, rwe_lang)"></textarea></td>
									</tr>

									<tr>
										<th>数学問題内容<span class="fontc-2">*</span></th>
										<td><input type="radio" value="yes" name="rwe_math_check"
											onclick="open_close_row('rwe_math',1);document.getElementById('rwe_math').focus();"
											onkeypress="return handleEnter(this, event)" /> <label
											for="rb2">有る</label> <input id="none" type="radio" value="no"
											name="rwe_math_check" checked
									...
									<tr id="rwe_math1">
										...
										<td><span id="slen3"></span> <span id="mes3-1"
											...
											style="font-size: 12px"></span> <br /> <TEXTAREA
												id="rwe_math" name="rwe_math" disabled="true" rows="5"
												cols="50" onfocus="test(3, rwe_math)"
												onKeyup="test(3, rwe_math)"></textarea></td>
									</tr>

									<tr>
										<th>英語問題内容<span class="fontc-2">*</span></th>
										<td><input type="radio" value="yes"
											name="rwe_english_check"
											onclick="open_close_row('rwe_english',1);document.getElementById('rwe_english').focus();"
											onkeypress="return handleEnter(this, event)" /> <label
											for="rb2">有る</label> <input id="none" type="radio" value="no"
											name="rwe_english_check" checked
									...
									<tr id="rwe_english1">
										...
										<td><span id="slen4"></span> <span id="mes4-1"
											...
											style="font-size: 12px"></span> <br /> <TEXTAREA
												id="rwe_english" name="rwe_english" disabled="true" rows="5"
												cols="50" onfocus="test(4, rwe_english)"
												onKeyup="test(4, rwe_english)"></textarea></td>
									</tr>

									<tr>
										<th>理科問題内容<span class="fontc-2">*</span></th>
										<td><input type="radio" value="yes"
											name="rwe_science_check"
											onclick="open_close_row('rwe_science',1);document.getElementById('rwe_science').focus();"
											onkeypress="return handleEnter(this, event)" /> <label
											for="rb2">有る</label> <input id="none" type="radio" value="no"
											name="rwe_science_check" checked
											onclick="open_close_row('rwe_science',2);"
											onkeypress="return handleEnter(this, event)" /> <label
											for="rb4">無し</label></td>
									</tr>
									<tr id="rwe_science_check1">
										<th>どんな問題か</th>
										<td><span id="slen5"></span> <span id="mes5-1"
											style="font-size: 12px"></span> <span id="mes5-2"
											style="font-size: 12px"></span> <br /> <TEXTAREA
												id="rwe_science" name="rwe_science" disabled="true" rows="5"
												cols="50" onfocus="test(5, rwe_science)"
												onKeyup="test(5, rwe_science)"></textarea></td>
									</tr>

									<tr>
										<th>社会問題内容<span class="fontc-2">*</span></th>
										<td><input type="radio" value="yes"
											name="rwe_society_check"
											onclick="open_close_row('rwe_society',1);document.getElementById('rwe_society').focus();"
											onkeypress="return handleEnter(this, event)" /> <label
											for="rb2">有る</label> <input id="none" type="radio" value="no"
											name="rwe_society_check" checked
									...
									<tr id="rwe_society1">
										...
										<td><span id="slen6"></span> <span id="mes6-1"
											...
											style="font-size: 12px"></span> <br /> <TEXTAREA
												id="rwe_society" name="rwe_society" disabled="true" rows="5"
												cols="50" onfocus="test(6, rwe_society)"
												onKeyup="test(6, rwe_society)"></textarea></td>
									</tr>

									<tr>
										<th>政治・経済問題内容<span class="fontc-2">*</span></th>
										<td><input type="radio" value="yes"
											name="rwe_politics_check"
											onclick="open_close_row('rwe_politics',1);document.getElementById('rwe_politics').focus();"
											onkeypress="return handleEnter(this, event)" /> <label
											for="rb2">有る</label> <input id="none" type="radio" value="no"
											name="rwe_politics_check" checked
									...
									<tr id="rwe_politics1">
										...
										<td><span id="slen7"></span> <span id="mes7-1"
											...
											style="font-size: 12px"></span> <br /> <TEXTAREA
												id="rwe_politics" name="rwe_politics" disabled="true"
												rows="5" cols="50" onfocus="test(7, rwe_politics)"
												onKeyup="test(7, rwe_politics)"></textarea></td>
									</tr>
									<tr>
									...
									<tr id="rwe_expert1">
										...
										<td><span id="slen8"></span> <span id="mes8-1"
											...
											style="font-size: 12px"></span> <br /> <TEXTAREA
												id="rwe_expert" name="rwe_expert" disabled="true" rows="5"
												cols="50" onfocus="test(8, rwe_expert)"
												onKeyup="test(8, rwe_expert)"></textarea></td>
									</tr>
									<tr>
									...
									<tr id="rwe_paper1">
										...
										<td><span id="slen9"></span> <span id="mes9-1"
											...
											style="font-size: 12px"></span> <br /> <TEXTAREA
												id="rwe_paper" name="rwe_paper" disabled="true" rows="5"
												cols="50" onfocus="test(9, rwe_paper)"
												onKeyup="test(9, rwe_paper)"></textarea></td>
									</tr>
									<tr>
										<th>その他問題内容</th>
										<td><span id="slen10"></span> <span id="mes10-1"
											...
											style="font-size: 12px"></span> <br /> <TEXTAREA
												...
												onfocus="test(10, rwe_other)" onKeyup="test(10, rwe_other)"></textarea>
										</td>
									</tr>
								</table>
							</fieldset> <!-- ここから分割されて -->
								...
								<table id="table-02">
									<tr>
										...
										<td><select ID="accept_year" name="rwe_accept_year"
											...
											onchange="nexttimeYearLoad();">
												<option value="">--</option>
										</select><label>日 頃</label> <input type="hidden"
											name="accept_year_value" id="accept_year_value" value="">
											<input type="hidden" name="accept_month_value"
											id="accept_month_value" value=""> <input
									...
									<tr>
										...
										<td><input type="radio" value="有る"
											name="rwe_nexttime_check"
											onclick="open_close_row_next('nexttime_year','nexttime_month','nexttime_day','rwe_nextexam','rwe_preparation',1);"
											onkeypress="return handleEnter(this, event)" /> <label
											for="rb1">有る</label> <input id="noneNext" type="radio"
											value="有るが未定" name="rwe_nexttime_check" checked
											onclick="open_close_row_next('nexttime_year','nexttime_month','nexttime_day','rwe_nextexam','rwe_preparation',2);"
											onkeypress="return handleEnter(this, event)" /> <label
											for="rb1">有るが未定</label> <input id="noneNext" type="radio"
											value="無し" name="rwe_nexttime_check" checked
											onclick="open_close_row_next('nexttime_year','nexttime_month','nexttime_day','rwe_nextexam','rwe_preparation',3);"
											onkeypress="return handleEnter(this, event)" /> <label
											for="rb1">無し</label></td>
									</tr>
									<tr id="col1">
									...
									<tr id="col2">
										...
										<td><span id="slen11"></span> <span id="mes11-1"
											...
											style="font-size: 12px"></span> <br /> <TEXTAREA
												id="rwe_nextexam" name="rwe_nextexam" disabled="true"
												rows="5" cols="50" onfocus="test(11, rwe_nextexam)"
												onKeyup="test(11, rwe_nextexam)"></textarea></td>
									</tr>
									<tr id="col3">
										<th>準備知識・情報</th>
										<td><span id="slen12"></span> <span id="mes12-1"
											...
											style="font-size: 12px"></span> <br /> <TEXTAREA
												id="rwe_preparation" name="rwe_preparation" disabled="true"
												rows="5" cols="50" onfocus="test(12, rwe_preparation)"
												onKeyup="test(12, rwe_preparation)"></textarea></td>
									</tr>
									</tbody>
								</table>
							</fieldset>
...
-->
	...
	if($('input[name=rwe_nexttime_check][value=無し]').attr('checked') || $('input[name=rjm_nexttime][value=有るが未定]').attr('checked')){
