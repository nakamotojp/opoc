...
<body
	...
	<div id="print">
		...
		<!--この行で見出し表示 -->
		<h2><%=xss.escape((String)request.getAttribute("comp_name")) %><br />筆記試験報告書
		</h2>
	...
	%>
					...
					<td class="ren5"><%=request.getAttribute("rwe_stage") %>試験</td>
				</tr>
				<tr>
					<th>受験した企業名</th>
				...
				<tr>
					<th>住所</th>
					<td colspan="5"><%=request.getAttribute("comp_address") %>
				</tr>
				<tr>
					<th>他校受験人数</th>
					<td><%=request.getAttribute("rwe_examother") %>人</td>
					<th>当校受験人数</th>
					<td colspan="4"><%=request.getAttribute("rwe_exam") %>人</td>
				</tr>

				<tr>
					<th>他校受験者出身校</th>
					<td colspan="5"><%=request.getAttribute("rwe_examotherschool") %></td>
				</tr>

				<tr>
					<th>適性検査内容</th>
					<td colspan="3"><%=transferCRLT((String)request.getAttribute("rwe_aptitude")) %></td>
					<th>適性検査時間</th>
				...
				<tr>
					...
					<th>作文・論文時間</th>
					<td colspan="5"><%=request.getAttribute("rwe_papertime") %>分</td>
				</tr>
				<tr>
					<th>国語問題内容</th>
					<td colspan="5">
    	  ...
    	  %>
				...
				<tr>
					<th>その他問題内容</th>
					<td colspan="5"><%=transferCRLT((String)request.getAttribute("rwe_other")) %></td>
				</tr>
				<tr>
					<th>合否連絡</th>
					<td colspan="5">
	...
	out.print(ary[2] + "日");
      ...
      out.print("無し");
		...
		有るが未定
			...
			<tr>
				<th>次回試験内容</th>
				<td colspan="5"><%=transferCRLT((String)request.getAttribute("rwe_nextexam")) %>
				</td>
			</tr>
			<tr>
				<th>準備知識・情報</th>
				<td colspan="5"><%=transferCRLT((String)request.getAttribute("rwe_preparation")) %>
				</td>
