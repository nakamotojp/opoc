						...
						<span id="SignupForm">
									...
									<tbody>
										...
										<tr>
											...
											<td><INPUT type="text" id="roe_interviewer"
												...
												onkeypress="return handleEnter(this, event)">人　　<span style="color:#999999">※半角数字のみ</span>
												</td>
										</tr>
										...
										<tr>
											...
											<td><span id="slen1"></span> <span id="mes1-1"
												...
												style="font-size: 12px"></span> <br /> <TEXTAREA
													id="roe_nameortitle" name="roe_nameortitle" rows="5"
													cols="50" onfocus="test(1,roe_nameortitle)"
													onkeyup="test(1,roe_nameortitle)"></TEXTAREA></td>
										</tr>
								</table>
								...
								<table id="table-02">
									...
									<tr id="roe_discussion2">
										...
										<td><INPUT type="text" id="roe_discussiontime"
											...
											disabled="true"　onkeypress="return handleEnter(this, event)">分　　<span style="color:#999999">※半角数字のみ</span>
											</td>
									</tr>
									...
									<tr id="roe_discussion3">
										...
										<td><span id="slen2"></span> <span id="mes2-1"
											...
											style="font-size: 12px"></span> <br /> <TEXTAREA
												id="roe_discussiontheme" name="roe_discussiontheme" rows="5"
												cols="50" onfocus="test(2,roe_discussiontheme)"
												onkeyup="test(2,roe_discussiontheme)" disabled="true"></TEXTAREA></td>
									</tr>
							...
							<fieldset>
								...
								<table id="table-03">
									...
									<tr>
										<th>質問</th>
										<td><TEXTAREA id="roeq_question0" name="roeq_question0" maxlength="200" class="limited"
												rows="5" cols="50"></TEXTAREA></td>
									</tr>
									<tr>
										<th>回答</th>
										<td><TEXTAREA id="roeq_answer0" name="roeq_answer0" maxlength="200" class="limited"
												rows="5" cols="50"></TEXTAREA></td>
									</tr>
									<tr>
										<th></th>
										<td>
											...
											<button type="button" id=delrow
												onClick="deleteTable2('roeq_question_r','roeq_answer_r','table-03','delrow');"
								...
								<table id="table-02">
									...
									<tr>
										...
										<td><input type="radio" value="有る"
											...
											onkeypress="return handleEnter(this, event)" /> <label
											for="rb2">有る</label> <input id="noneNext" type="radio"
											value="有るが未定" name="roe_nexttime_check" checked
											...
											value="無し" name="roe_nexttime_check" checked
									...
									<tr>
										...
										<td><span id="slen3"></span> <span id="mes3-1"
											...
											style="font-size: 12px"></span> <br /> <TEXTAREA
												id="roe_nextexam" name="roe_nextexam" rows="5" cols="50"
												onfocus="test(3,roe_nextexam)"
												onkeyup="test(3,roe_nextexam)" disabled="true"></TEXTAREA></td>
									</tr>
									<tr>
										<th>準備知識・情報</th>
										<td><span id="slen4"></span> <span id="mes4-1"
											...
											style="font-size: 12px"></span> <br /> <TEXTAREA
												id="roe_preparation" name="roe_preparation" rows="5"
												cols="50" onfocus="test(4,roe_preparation)"
												onkeyup="test(4,roe_preparation)" disabled="true"></TEXTAREA></td>
									</tr>
							...
							<div id="button1">
								<input id="SaveAccount" type="submit" value=""
