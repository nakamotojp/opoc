...
function jump1() {
	...
	function jump2() {
	location.href= "./student/o_jub_hunting_top.jsp";
	}
	...
	<div id="container">
		...
		<div id="contents">
			...
			<div id="wrap">
				...
				<div id="main">
					<div id="bana">
						<!--　各種機能のイメージ  -->
						<a href="WrittenExaminationInsert"><img
							src="images/bana/o_written_e_power.png" alt="筆記試験報告書入力ページへ"></img></a>
					</div>
					<span id="SignupForm"> <%
      	if(list.size()== 0){
			%>
		...
		if(i%10==0){
			...
			if(comp_name.length() >= 30){
				comp_name = comp_name.substring(0,30) + "...";
